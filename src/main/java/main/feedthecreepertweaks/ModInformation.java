...
public class ModInformation
{
   ...
   public static final String DEPEND = "required-after:progressiveautomation;required-after:Metallurgy;required-after:metallurgycm;required-after:Metallurgy;required-after:TConstruct;after:ExtraTiC";
